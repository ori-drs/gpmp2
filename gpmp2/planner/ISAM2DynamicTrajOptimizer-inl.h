/**
 *  @file  ISAM2DynamicTrajOptimizer-inl.h
 *  @brief incremental planner using iSAM2 for dynamic scenes
 *  @author Mark Finean
 *  @date  April 15, 2020
 **/
...
ISAM2DynamicTrajOptimizer<ROBOT, GP, SDF, OBS_FACTOR, OBS_FACTOR_GP, LIMIT_FACTOR_POS, LIMIT_FACTOR_VEL>::
    ISAM2DynamicTrajOptimizer(const ROBOT& arm, const SDF& sdf, const TrajOptimizerSetting& setting) :
...
template <class ROBOT, class GP, class SDF, class OBS_FACTOR, class OBS_FACTOR_GP,
    class LIMIT_FACTOR_POS, class LIMIT_FACTOR_VEL>
void ISAM2DynamicTrajOptimizer<ROBOT, GP, SDF, OBS_FACTOR, OBS_FACTOR_GP, LIMIT_FACTOR_POS, LIMIT_FACTOR_VEL>::
