 ...
 */
GPMP2_EXPORT gtsam::Values DynamicTrajOptimize2DArm(
 ...
 * @return optimized values, x(0) - x(setting.total_step), v(0) - v(setting.total_step)
 */
GPMP2_EXPORT gtsam::Values DynamicTrajOptimize3DArm(
 ...
 * @return optimized values, x(0) - x(setting.total_step), v(0) - v(setting.total_step)
 */
GPMP2_EXPORT gtsam::Values DynamicTrajOptimizePose2MobileArm2D(
 ...
 * @return optimized values, x(0) - x(setting.total_step), v(0) - v(setting.total_step)
 */
GPMP2_EXPORT gtsam::Values DynamicTrajOptimizePose2MobileArm(
...
// Pose2Mobile2Arms
GPMP2_EXPORT gtsam::Values DynamicTrajOptimizePose2Mobile2Arms(
...
GPMP2_EXPORT gtsam::Values DynamicTrajOptimizePose2MobileVetLinArm(
...
GPMP2_EXPORT gtsam::Values DynamicTrajOptimizePose2MobileVetLin2Arms(
...
gtsam::Values DynamicTrajOptimize(
...
#include "DynamicTrajOptimizer-inl.h"
