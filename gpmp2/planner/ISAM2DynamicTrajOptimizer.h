/**
 *  @file  ISAM2DynamicTrajOptimizer.h
 *  @brief incremental planner using iSAM2 for dynamic sdfs
 *  @author Mark Finean
 *  @date  April 15, 2020
 **/
...
class ISAM2DynamicTrajOptimizer {
...
public:
  /// default constructor
  ISAM2DynamicTrajOptimizer() {}

  /// constructor
  ISAM2DynamicTrajOptimizer(const ROBOT& arm, const SDF& sdf,
  ...
  const gtsam::VariableIndex& getVariableIndex() const {return isam_.getVariableIndex();}
...
typedef internal::ISAM2DynamicTrajOptimizer<ArmModel, GaussianProcessPriorLinear,
    ...
    JointLimitFactorVector, VelocityLimitFactorVector>
ISAM2DynamicTrajOptimizer3DArm;


/// 2D mobile arm specialization
typedef internal::ISAM2DynamicTrajOptimizer<Pose2MobileArmModel, GaussianProcessPriorPose2Vector,
...
ISAM2DynamicTrajOptimizerPose2MobileArm2D;
...
typedef internal::ISAM2DynamicTrajOptimizer<Pose2MobileArmModel, GaussianProcessPriorPose2Vector,
    ...
    JointLimitFactorPose2Vector, VelocityLimitFactorVector>
ISAM2DynamicTrajOptimizerPose2MobileArm;


/// 3D mobile arm specialization
typedef internal::ISAM2DynamicTrajOptimizer<Pose2MobileVetLin2ArmsModel, GaussianProcessPriorPose2Vector,
    SignedDistanceField, ObstacleSDFFactorPose2MobileVetLin2Arms, ObstacleSDFFactorGPPose2MobileVetLin2Arms,
    JointLimitFactorPose2Vector, VelocityLimitFactorVector>
ISAM2DynamicTrajOptimizerPose2MobileVetLin2Arms;

}   // namespace gpmp2

#include "ISAM2DynamicTrajOptimizer-inl.h"
