/**
 *  @file  DynamicTrajOptimizer.cpp
 *  @brief Dynamic trajectory optimizer
 *  @author Mark Finean
 *  @date  April 15, 2020
 **/

#include <gpmp2/planner/DynamicTrajOptimizer.h>
...
/* ************************************************************************** */
gtsam::Values DynamicTrajOptimize2DArm(
  ...
  return internal::DynamicTrajOptimize<ArmModel, GaussianProcessPriorLinear,
...
/* ************************************************************************** */
gtsam::Values DynamicTrajOptimize3DArm(
...
/* ************************************************************************** */
gtsam::Values DynamicTrajOptimizePose2MobileArm2D(
  ...
  return internal::DynamicTrajOptimize<Pose2MobileArmModel, GaussianProcessPriorPose2Vector,
...
/* ************************************************************************** */
gtsam::Values DynamicTrajOptimizePose2MobileArm(
...
/* ************************************************************************** */
gtsam::Values DynamicTrajOptimizePose2Mobile2Arms(
    const Pose2Mobile2ArmsModel& marm, const SignedDistanceField& sdf,
    const Pose2Vector& start_conf, const gtsam::Vector& start_vel,
    const Pose2Vector& end_conf, const gtsam::Vector& end_vel,
    const gtsam::Values& init_values, const TrajOptimizerSetting& setting) {

  return internal::DynamicTrajOptimize<Pose2Mobile2ArmsModel, GaussianProcessPriorPose2Vector,
...
/* ************************************************************************** */
gtsam::Values DynamicTrajOptimizePose2MobileVetLinArm(
    const Pose2MobileVetLinArmModel& marm, const SignedDistanceField& sdf,
    const Pose2Vector& start_conf, const gtsam::Vector& start_vel,
    const Pose2Vector& end_conf, const gtsam::Vector& end_vel,
    const gtsam::Values& init_values, const TrajOptimizerSetting& setting) {

  return internal::DynamicTrajOptimize<Pose2MobileVetLinArmModel, GaussianProcessPriorPose2Vector,
...
/* ************************************************************************** */
gtsam::Values DynamicTrajOptimizePose2MobileVetLin2Arms(
    const Pose2MobileVetLin2ArmsModel& marm, const SignedDistanceField& sdf,
    const Pose2Vector& start_conf, const gtsam::Vector& start_vel,
    const Pose2Vector& end_conf, const gtsam::Vector& end_vel,
    const gtsam::Values& init_values, const TrajOptimizerSetting& setting) {

  return internal::DynamicTrajOptimize<Pose2MobileVetLin2ArmsModel, GaussianProcessPriorPose2Vector,
