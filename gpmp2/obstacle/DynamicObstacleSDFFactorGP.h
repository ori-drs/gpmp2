/**
 *  @file  DynamicObstacleSDFFactorGP.h
...
class DynamicObstacleSDFFactorGP: public gtsam::NoiseModelFactor4<
...
private:
  // typedefs
  typedef DynamicObstacleSDFFactorGP This;
...
public:
  ...
  DynamicObstacleSDFFactorGP() : robot_(Robot()), sdf_(SignedDistanceField()) {}
   ...
   */
  DynamicObstacleSDFFactorGP(
      gtsam::Key pose1Key, gtsam::Key vel1Key, gtsam::Key pose2Key, gtsam::Key vel2Key,
      const Robot& robot, SignedDistanceField& sdf, double cost_sigma,
  ...
  virtual ~DynamicObstacleSDFFactorGP() {}
  ...
  void print(const std::string& s="", const gtsam::KeyFormatter& keyFormatter =gtsam:: DefaultKeyFormatter) const {
    std::cout << s << "DynamicObstacleSDFFactorGP :" << std::endl;
...
#include <gpmp2/obstacle/DynamicObstacleSDFFactorGP-inl.h>
