...
%     torso_T_arm = Pose3(Rot3(), Point3([0, 0, 0]'));
    ...
    torso_T_arm = Pose3(Rot3.RzRyRx(1.57, 0, 3.14), Point3([0.151, 0.078, 0]'));
...
%         ];
    ...
    spheres_data = [...
        ...
        2  0.01 0.01 0.00 0.11
        2  0.01 0.01 -0.12 0.11
        2  0.01 0.01 -0.22 0.11
        
        3  0.01 0.00 0.00 0.10
        3  0.01 -0.07 0.00 0.10
                     
        5  0.00 0.00 0.00 0.02
        5  -0.10 0.00 0.00 0.09
        5  -0.15 0.04 0.00 0.04
        5  -0.15 -0.04 0.00 0.04
        5  -0.19 0.04 0.00 0.04
        5  -0.19 -0.04 0.00 0.04        
        ];
