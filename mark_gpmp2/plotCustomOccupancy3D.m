function h = plotCustomOccupancy3D(field, origin, cell_size, epsilon_dist, marker_size)
%PLOTSIGNEDDISTANCEFIELD3D plot 3D SignedDistanceField
%
%   Usage: plotCustomOccupancy3D(field, origin, cell_size, epsilon_dist)
...
h = plot3(grid_X(y), grid_Y(x), grid_Z(z), '.', 'Color', [1, 0, 0], 'MarkerSize', marker_size);
...
axis([origin(1)-cell_size/2, 1.3, ...
    origin(2)-cell_size/2, 1.3, ...
    origin(3)-cell_size/2, 1.3])
