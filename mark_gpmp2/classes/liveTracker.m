 classdef liveTracker < handle
    ...
    methods
        function obj = liveTracker(map_size, static_map, epsilon, cell_size, origin_point3)
        ...
        function predicted_sdf = predict_composite_sdf(obj, t)
        ...
        function val = predict_field(obj, t)
            ...
            predicted_map  = flip(predicted_map);
