function collision_t_update_case = case5(datasets, init_values, problem_setup)
...
%     update_timings.factors_updated = cell(1, problem_setup.total_time_step+1);
    ...
    for i = 0:problem_setup.total_time_step
        disp("Case5: Execute and selectively update sdf... step: " + num2str(i));
...
%                     update_timings.factors_updated{i+1} = vertcat(update_timings.factors_updated{i+1},all_obs_fact_indices{j+1});
    ...
    collision_t_update_case.final_result = result;
    collision_t_update_case.results = results;
    collision_t_update_case.graph_build_t = graph_build_t;
    collision_t_update_case.update_timings = update_timings;
    collision_t_update_case.all_obs_fact_indices = all_obs_fact_indices;
    collision_t_update_case.obs_fact_indices = obs_fact_indices;
