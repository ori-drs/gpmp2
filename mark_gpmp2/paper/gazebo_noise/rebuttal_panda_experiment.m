...
num_experiments = num_algos * num_repeats * length(variances) * num_speeds;
experiment_results = zeros(num_experiments, 7);
...
for algo = [0,1,2,3]
    for speed = speeds
        ...
        %             pause(4);
                    ...
                    experiment_results(exp_num, :) = [algo, speed, var, col_free_bool, num_collisions, smoothness_cost, num_replans];
                catch
                    disp("Encountered a problem. Skipping");
                    experiment_results(exp_num, :) = [algo, speed, var, 1000, 1000, 1000, 1000];
                end
...
writematrix(experiment_results,'/home/mark/installs/gpmp2/mark_gpmp2/paper/gazebo_noise/results/results_64_varspeed.csv')