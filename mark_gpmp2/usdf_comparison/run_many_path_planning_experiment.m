...
% save('/home/mark/installs/gpmp2/mark_gpmp2/usdf_comparison/2dresults.mat', ...
% 'confs', ...
% 'delta_t_range', ...
% 'cell_size', ...
% 'combos',  ...
...
% 'total_time_step')
% % 
% writematrix(results_log,'/home/mark/installs/gpmp2/mark_gpmp2/usdf_comparison/2dresults.csv');
