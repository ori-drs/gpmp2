function problem_setup = HSRProblemSetup(start_conf, end_conf, total_time_sec, delta_t, ...
                                         cost_sigma, epsilon_dist, interp_multiplier, limit_x, limit_v)
                                     
%HSRPROBLEMSETUP Summary of this function goes here
%   Detailed explanation goes here
    import gtsam.*
    import gpmp2.*
    
    arm = generateMobileArm('HSR');
    ...
    pose_fix_model = gtsam.noiseModel.Isotropic.Sigma(8, pose_fix_sigma);
    vel_fix_model = gtsam.noiseModel.Isotropic.Sigma(8, vel_fix_sigma);
